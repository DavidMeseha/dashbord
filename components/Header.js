...
const Header = () => {
    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', margin: '0 5px 15px 5px' }}>
            ...
            <div className="minue-icon" onClick={toggleNavBar}>
                <div style={{ width: '100%', height: 4, background: 'rgb(159 159 159)', borderRadius: 20 }}></div>
                <div style={{ width: '100%', height: 4, background: 'rgb(159 159 159)', margin: '5px 0', borderRadius: 20 }}></div>
                <div style={{ width: '100%', height: 4, background: 'rgb(159 159 159)', borderRadius: 20 }}></div>
            </div>
